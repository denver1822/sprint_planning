...
Приложение проводит синхронные сессии Planning Poker в комнатах по ссылке. Участники входят по отображаемому имени без регистрации. Jira — необязательный источник задач; ручные задачи и сессия без задач поддерживаются обязательно.
